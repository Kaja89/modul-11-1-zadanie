...
public class Checkers {
    ...
    public static class CheckersBuilder {
        ...
        public CheckersBuilder figure(String figureType, String figureColor, int x, int y){
            if(x> Board.MAX_INDEX || x<Board.MIN_INDEX || y<Board.MIN_INDEX || y> Board.MAX_INDEX){
        ...
        public Checkers build(){
            ...
            if(!(black && white)){
                throw new IllegalStateException("There are no figures of any color on the board");
            }
